...
namespace tiket_reservation.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            foreach (var entity in db.ChangeTracker.Entries()) { entity.Reload(); }
        }

        public ActionResult Login_user()
        {
            if (Session["user"] != null) { return RedirectToAction("dashboard", "User"); }
            return View();
        }
        ...
        public ActionResult Login_user(pembeli postPembeli)
        {
            ...
            bool comparePassword = PBKDF2Encryption.VerifyHashedPassword(pb.password, postPembeli.password);
        ...
        public ActionResult Login_admin(admin postAdmin)
        {
            ...
            bool comparePassword = PBKDF2Encryption.VerifyHashedPassword(ad.pass_admin, postAdmin.pass_admin);
        ...
        public ActionResult daftar(Gabungan gabungan)
        {
            ...
            string hashPass = PBKDF2Encryption.HashPassword(gabungan.tblPembeli.password);
            // table Pembeli 
            ...
            db.pembeli.Add(dbPembeli); db.SaveChanges();
